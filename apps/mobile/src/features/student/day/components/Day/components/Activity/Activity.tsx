...
import { Activity as ActivityType, ClockTypeEnum } from "@routine-support/domains";
...
export const Activity: React.FC<ActivityProps> = ({ activity, isPassed = true, clockType }) => {

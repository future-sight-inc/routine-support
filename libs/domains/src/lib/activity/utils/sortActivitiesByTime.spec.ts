...
const REGULAR_UNSORTED_ACTIVITIES = [TWO_PM_ACTIVITY, ONE_PM_ACTIVITY, THREE_PM_ACTIVITY];
const REGULAR_SORTED_ACTIVITIES = [ONE_PM_ACTIVITY, TWO_PM_ACTIVITY, THREE_PM_ACTIVITY];
...
describe("sortActivitiesByTime", () => {
  ...
  it("Unsorted array of activities with duplicates", () => {
    const sortedActivities = sortActivitiesByTime(WITH_DUPLICATES_UNSORTED_ACTIVITIES);

    expect(sortedActivities).toStrictEqual(WITH_DUPLICATES_SORTED_ACTIVITIES);
  });

  it("Sorted array of activities with duplicates", () => {
    const sortedActivities = sortActivitiesByTime(WITH_DUPLICATES_SORTED_ACTIVITIES);
